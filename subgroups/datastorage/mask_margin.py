...
class MaskMarginStorageInterface(ABC):
    """
    Interface for managing storage of masks and margins for multiple classifiers.

    This interface defines the structure for storing and accessing masks, margins,
    and test accuracies associated with a set of classifiers. It ensures that implementations
...
class MaskMarginStorage(MaskMarginStorageInterface):
    """
    Storage class for managing masks, margins, and test accuracies for multiple classifiers.
